...
const cookieConfig = {
     ...
     * 
     * maxAge: 쿠키의 수명
     * expires: 만료날짜를 GMT 시간을 설정 (maxAge와 같이 사용 불가능)
     * 
     ...
     * 
     * signed: 쿠키의 수정불가 결정. 쿠키가 서명되어 클라이언트가 쿠키를 수정하는 것을 방지
     */
...
app.get('/getCookie', (req, res) => {
    // 쿠키값 가져오기
    // console.log('쿠키 값: ', req.cookies.myCookie);
    // res.send(req.cookies);
    console.log('암호화 된 쿠키값: ', req.signedCookies.myCookie);
